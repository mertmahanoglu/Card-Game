...
$(document).ready(function() {
    ...
    function correctAudio() {
      ...
      var cards = ['queen', 'king', 'bishop', 'rook', 'knight','pawn','beyazsah','beyazvezir','beyazkale','beyazfil','beyazat','beyazpiyon']; //Kartların id'leri alınıyor
      ...
      const dakika=2;//Dakika
      let time = dakika*60;//Toplam Saniye
          ...
          //Seçilen kartların 2si de seçilmemişse if'e gir
                ...
                //1 kart seçilmiş diğeri seçilmemişse if'e gir
                  ...
                  if (seciliKartlar[0] == seciliKartlar[1]) {
                    ...
                    console.log(seciliKartlar[0]);
                    console.log(allCard);
                    console.log(allCard[2]);
